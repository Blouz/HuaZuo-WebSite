...
/* extension/module/isenselabs_seo/advanced_editor_tab/categories_ajax.twig */
class __TwigTemplate_c39da79936cfc870eb9b780a672d8773989b1da161193f720e8a570282d601bb extends Twig_Template
{
...
<ul class=\"nav nav-pills nav-pills-languages\" role=\"tablist\">
    ...
    ";
        ...
        echo "</ul>
<br />
<table class=\"table table-striped table-editor table-editor-categories\" data-type=\"category\" data-language-id=\"";
        // line 10
    ...
    <thead>
        ...
        echo (isset($context["language_id"]) ? $context["language_id"] : null);
        echo "\" />
                <a onClick=\"filterData('.filter-categories');\" class=\"btn btn-primary\">";
        // line 39
    ...
    <tbody> 
        ...
        if ((twig_length_filter($this->env, (isset($context["sources"]) ? $context["sources"] : null)) > 0)) {
            ...
            <tr> 
                <th scope=\"row\">";
                // line 47
                echo $this->getAttribute($context["result"], "category_id", array());
                echo "</th> 
                <td>";
                // line 48
                echo $this->getAttribute($context["result"], "name", array());
                echo "</td> 
                <td id=\"category_seo_keyword_";
                // line 49
                echo $this->getAttribute($context["result"], "category_id", array());
                ...
                echo "</span></td> 
                <td id=\"category_meta_description_";
                // line 51
                echo $this->getAttribute($context["result"], "category_id", array());
                echo "\" onDblClick=\"editField(";
                echo $this->getAttribute($context["result"], "category_id", array());
    ...
    {
        return "extension/module/isenselabs_seo/advanced_editor_tab/categories_ajax.twig";
    }
...
/* </ul>*/
/* <br />*/
/* <table class="table table-striped table-editor table-editor-categories" data-type="category" data-language-id="{{ language_id }}"> */
/*     <thead>*/
/*         <tr> */
/*             <th>#</th> */
...
/*                 <a onClick="filterData('.filter-categories');" class="btn btn-primary">{{ text_filter }}</a>*/
/*             </th>*/
/*         </tr>*/
/*     </thead> */
/*     <tbody> */
...
/*             <tr> */
/*                 <th scope="row">{{ result.category_id }}</th> */
/*                 <td>{{ result.name }}</td> */
/*                 <td id="category_seo_keyword_{{ result.category_id }}" onDblClick="editField({{ result.category_id }}, 'url_alias', this);"><span class="editable">{{ result.seo_keyword }}</span></td> */
/*                 <td id="category_meta_title_{{ result.category_id }}" onDblClick="editField({{ result.category_id }}, 'meta_title', this);"><span class="editable">{{ result.meta_title }}</span></td> */
/*                 <td id="category_meta_description_{{ result.category_id }}" onDblClick="editField({{ result.category_id }}, 'meta_description', this);"><span class="editable">{{ result.meta_description }}</span></td> */
/*                 <td id="category_meta_keyword_{{ result.category_id }}"onDblClick="editField({{ result.category_id }}, 'meta_keyword', this);"><span class="editable">{{ result.meta_keyword }}</span></td> */
/*                 <td></td>*/
/*                 <td></td>*/
/*             </tr> */
/*             {% endfor %} */
