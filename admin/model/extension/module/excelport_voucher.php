...
class ModelExtensionModuleExcelportvoucher extends ModelExtensionModuleExcelport {
	...
	public function importXLSVouchers($file, $importLimit) {
		...
		do {
			...
			if ($voucher_code !== "") {
				$voucher_id = $vouchersSheetObj->getCell(PHPExcel_Cell::stringFromColumnIndex($source[0] + $voucher_map['voucher_id']) . ($source[1]))->getValue();
