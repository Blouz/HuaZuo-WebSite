...
class ControllerCommonFileManager extends Controller {
  ...
  public function pim() {
    ...
    if ($this->config->get('pim_status')) {
      ...
      $data['dirimage'] = HTTP_CATALOG."image/";
			$data['https_catalog'] = HTTPS_CATALOG."image/";
			
			
      
      $this->response->setOutput($this->load->view('extension/module/fmpim', $data));
      return;
    } else {
      ...
      if (isset($this->request->get['CKEditor'])) {
        $data['cke'] = $this->request->get['CKEditor'];
  		...
  		if (isset($this->request->get['CKEditorFuncNum'])) {
  			$data['cke'] = $this->request->get['CKEditorFuncNum'];
  		}           
