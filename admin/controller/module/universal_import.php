...
class ControllerModuleUniversalImport extends Controller {
  ...
  public function __construct($registry) {
    ...
    // Export
    $data['export_types'] = $export_types = array('product', 'category', 'information', 'manufacturer', 'customer', 'order');
  ...
  public function get_option_fields() {
    ...
    $columns = json_decode(base64_decode($this->request->post['column_headers']));
    ...
    */
    ...
    if (1) {
      foreach (array('type', 'name', 'value', 'price_prefix', 'price', 'quantity', 'subtract', 'weight', 'required') as $field) {
        $output .= '<tr>';
