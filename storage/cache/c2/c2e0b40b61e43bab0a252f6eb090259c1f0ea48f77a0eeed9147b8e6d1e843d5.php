...
/* extension/module/isenselabs_seo/advanced_editor_tab/informations_ajax.twig */
class __TwigTemplate_7a574773b7b6cc5dfcac2809c40da306849f9871364b8f85ac28edf837ddee76 extends Twig_Template
{
...
<ul class=\"nav nav-pills nav-pills-languages\" role=\"tablist\">
    ...
    ";
        ...
        echo "</ul>
<br />
<table class=\"table table-striped table-editor table-editor-informations\" data-type=\"information\" data-language-id=\"";
        // line 10
    ...
    <thead>
        ...
        echo (isset($context["language_id"]) ? $context["language_id"] : null);
        echo "\" />
                <a onClick=\"filterData('.filter-informations');\" class=\"btn btn-primary\">";
        // line 39
    ...
    <tbody> 
        ...
        if ((twig_length_filter($this->env, (isset($context["sources"]) ? $context["sources"] : null)) > 0)) {
            ...
            <tr> 
                <th scope=\"row\">";
                // line 47
                echo $this->getAttribute($context["result"], "information_id", array());
                echo "</th> 
                <td>";
                // line 48
                echo $this->getAttribute($context["result"], "title", array());
                echo "</td> 
                <td id=\"information_seo_keyword_";
                // line 49
                echo $this->getAttribute($context["result"], "information_id", array());
                ...
                echo "</span></td> 
                <td id=\"information_meta_description_";
                // line 51
                echo $this->getAttribute($context["result"], "information_id", array());
                echo "\" onDblClick=\"editField(";
                echo $this->getAttribute($context["result"], "information_id", array());
                ...
                echo "</span></td> 
                <td id=\"information_meta_keyword_";
                // line 52
                echo $this->getAttribute($context["result"], "information_id", array());
                echo "\"onDblClick=\"editField(";
                echo $this->getAttribute($context["result"], "information_id", array());
    ...
    {
        return "extension/module/isenselabs_seo/advanced_editor_tab/informations_ajax.twig";
    }
    ...
    {
        return array (  229 => 68,  225 => 67,  217 => 61,  211 => 59,  205 => 57,  190 => 52,  182 => 51,  174 => 50,  166 => 49,  162 => 48,  158 => 47,  151 => 45,  147 => 44,  139 => 39,  135 => 38,  128 => 34,  124 => 33,  120 => 32,  116 => 31,  110 => 28,  106 => 27,  102 => 26,  98 => 25,  94 => 24,  87 => 20,  83 => 19,  79 => 18,  75 => 17,  71 => 16,  67 => 15,  63 => 14,  56 => 10,  52 => 8,  37 => 5,  29 => 4,  23 => 3,  19 => 1,);
    }
}
/* <br />*/
/* <ul class="nav nav-pills nav-pills-languages" role="tablist">*/
...
/*             <tr> */
/*                 <th scope="row">{{ result.information_id }}</th> */
/*                 <td>{{ result.title }}</td> */
