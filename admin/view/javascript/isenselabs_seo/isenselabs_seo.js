...
function seoFixNow(eventType, language_id) {
    ...
    switch(eventType) {
        ...
        default:
            $.ajax({
                url: fixIssuesAjaxURL + "&event_type=" + eventType + "&language_id=" + language_id,
                dataType: 'JSON',
                beforeSend: function() {
...
$(document).ready(function(e) {
    //SEO Basics sub-tabs
    $.ajax({
        url: "index.php?route=" + modulePath + "/tab_titles&" + token_string + "=" + token,
        type: 'get',
        dataType: 'html',
        success: function(data) { 
    ...
    $.ajax({
        url: "index.php?route=" + modulePath + "/tab_descriptions&" + token_string + "=" + token,
        type: 'get',
        dataType: 'html',
        success: function(data) { 
    ...
    $.ajax({
        url: "index.php?route=" + modulePath + "/tab_keywords&" + token_string + "=" + token,
        type: 'get',
        dataType: 'html',
        success: function(data) { 
    ...
    $.ajax({
        url: "index.php?route=" + modulePath + "/tab_seo_links&" + token_string + "=" + token,
        type: 'get',
        dataType: 'html',
        success: function(data) { 
...
function generateImageNames() {
    bootbox.confirm({
        ...
        callback: function (result) {
            if (result) {
                $.ajax({
                    url: "index.php?route=" + modulePath + "/generate_image_names&" + token_string + "=" + token,
                    type: 'get',
                    dataType: 'JSON',
                    beforeSend: function() {
                        Dialog = bootbox.alert({
...
function deleteDetectedPage(id) {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            if (result) {
                $.ajax({
                    url: "index.php?route=" + modulePath + "/remove_detected_page&" + token_string + "=" + token + "&id=" + id,
                    type: 'get',
                    dataType: 'JSON',
                    beforeSend: function() {
    ...
    if (links.length > 0) {
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    $.ajax({
                        url: "index.php?route=" + modulePath + "/remove_detected_pages&" + token_string + "=" + token,
                        type: 'POST',
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                $.ajax({
                    url: "index.php?route=" + modulePath + "/add_missing_page_redirect&" + token_string + "=" + token,
                    type: 'get',
...
function deleteRedirect(id) {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            if (result) {
                $.ajax({
                    url: "index.php?route=" + modulePath + "/remove_redirect&" + token_string + "=" + token + "&id=" + id,
                    type: 'get',
                    dataType: 'JSON',
                    beforeSend: function() {
    ...
    if (links.length > 0) {
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    $.ajax({
                        url: "index.php?route=" + modulePath + "/remove_redirects&" + token_string + "=" + token,
                        type: 'POST',
                        data: { results : links.serializeArray() },
                        dataType: 'JSON',
                        beforeSend: function() {
