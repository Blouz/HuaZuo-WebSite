...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
        ...
        // >> Parent-child Options
				...
				$data = array_merge( isset($data) ? $data : array(), $this->liveopencart_poip->getModel()->getProductPageData() );
		...
		foreach ($product_options as $product_option) {
			...
			if (isset($product_option['product_option_value'])) {
				...
				// Product Option Image PRO module <<
				'images' => (isset($product_option_value['images'])? $this->liveopencart_poip->getModel()->addThumbsIfNeeded($product_option_value['images']) : array()),
				// >> Product Option Image PRO module
        ...
        // << Parent-child Options
        'pcop'    => isset($product_option['pcop']) ? $product_option['pcop'] : false,
        // >> Parent-child Options
	...
	public function autocomplete() {
        ...
        // << Parent-child Options
				'pcop_front'    => isset($product_option['pcop_front']) ? $product_option['pcop_front'] : false,
        // >> Parent-child Options
