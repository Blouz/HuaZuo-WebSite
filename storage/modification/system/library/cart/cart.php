...
class Cart {
	...
	public function __construct($registry) {
				...
				$this->liveopencart_poip = \liveopencart\poip::getLibrary($registry);
	...
	public function getProducts() {
		...
		foreach ($cart_query->rows as $cart) {
			...
			if ($product_query->num_rows && ($cart['quantity'] > 0)) {
				...
				$product_query->row['image'] = $this->liveopencart_poip->getModel()->getProductCartImage($product_query->row['product_id'], $option_data, $product_query->row['image']);
