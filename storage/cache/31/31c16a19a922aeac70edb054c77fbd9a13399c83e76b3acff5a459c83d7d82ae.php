...
class __TwigTemplate_6368ecd5acfa21745c54746cad1be5963338fc9da2f945c0c2c1fb4b9b585c0d extends Twig_Template
{
...
<script>
  ...
  \$(document).delegate('.journal-checkout .confirm-button', 'click', function () {
    ...
    \$('.journal-checkout input[type=\"text\"], .journal-checkout input[type=\"password\"], .journal-checkout input[type=\"hidden\"], .journal-checkout select, .journal-checkout input:checked, .journal-checkout textarea').each(function () {
