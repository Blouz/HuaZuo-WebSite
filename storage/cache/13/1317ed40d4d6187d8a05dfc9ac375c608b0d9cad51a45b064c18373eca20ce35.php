...
/* journal2/template/extension/module/filter.twig */
class __TwigTemplate_b3108ca8a25e26371eb9d5becc0623a4180784f8501811ef720f5c38bcb98591 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"panel panel-default oc-module oc-filter\">
...
";
    ...
    {
        return "journal2/template/extension/module/filter.twig";
    }
...
/* <div class="panel panel-default oc-module oc-filter">*/
...
/*     {% endfor %}</div>*/
/*   <div class="panel-footer text-right">*/
/*     <button type="button" id="button-filter" class="btn btn-primary button">{{ button_filter }}</button>*/
/*   </div>*/
/* </div>*/
/* <script type="text/javascript"><!--*/
/* $('#button-filter').on('click', function() {*/
