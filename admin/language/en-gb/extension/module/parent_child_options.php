...
$_['entry_export_description']        = 'Export file format: XLS.<br>First row for fields names, next rows for data.';
...
Import file format: XLS. Import uses only the first sheet for getting data.
