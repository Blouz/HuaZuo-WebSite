    ...
    public function index($setting) {
        ...
        if ($cache === null || self::$CACHEABLE !== true) {
            ...
            // << Product Option Image PRO module
					...
					$this->data['poip_installed'] 	= $this->liveopencart_poip->installed();
					$this->data['poip_theme_name'] 	= $this->liveopencart_poip->getModel()->getThemeName();
    ...
    private function generateProductSections($sections_data) {
        ...
        foreach ($sections_data as $section) {
            ...
            foreach ($products as $product) {
				...
				// << Product Option Image PRO module
				'poip_images'  => $this->liveopencart_poip->getModel()->getCategoryImagesForController( $product['product_id'], (isset($setting) ? $setting : false) ),
				// >> Product Option Image PRO module
